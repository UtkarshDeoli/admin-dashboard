...
interface CastingSearchFormProps {
...
export default function CastingSearchForm({ 
  onSearch, 
  defaultFilters, 
  searching 
}: CastingSearchFormProps) {
  ...
  const handleClear = () => {
    const emptyFilters = { companyName: '', market: '', unions: '' };
