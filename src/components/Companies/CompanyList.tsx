      ...
      <table className="w-full table-auto">
        ...
        <tbody>
          {companies.map((company) => {
            const isDeleting = deleting.includes(company.company_no);
            
            return (
              <tr key={company.company_no} className="border-b border-stroke dark:border-strokedark">
                <td className="py-5 px-4">
                  <p className="text-black dark:text-white">{company.company_no}</p>
                </td>
                <td className="py-5 px-4">
                  <p className="text-black dark:text-white font-medium">{company.name}</p>
                </td>
                <td className="py-5 px-4">
                ...
                <td className="py-5 px-4">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <button
                      ...
                      onClick={() => !isDeleting && onDelete(company.company_no)}
                      title="Delete"
                      disabled={isDeleting}
                    >
                      {isDeleting ? (
