...
interface SchoolSearchFormProps {
  onSearch: (filters: { companyName: string; technique: string; policy: string }) => void;
  defaultFilters: { companyName: string; technique: string; policy: string };
  searching: boolean;
}
...
export default function SchoolSearchForm({ 
  ...
  const handleClear = () => {
    const emptyFilters = { companyName: '', technique: '', policy: '' };
